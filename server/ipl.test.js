...
describe('testing  number of matches per year ', () => {
...
describe('testing number of matches per team per year ', () => {
    ...
    test('Checking number of matches per team per year', () => {
        expect(IPL.matchesWonPerTeamPerSeason(sampledata)).toEqual({ 'Sunrisers Hyderabad': { '2008': 0, '2009': 0, "2013": 0, '2015': 1, '2017': 2 }, 'Delhi Daredevils': { '2008': 2, '2009': 1, "2013": 0, "2015": 0, "2017": 0 }, 'Kolkata Knight Riders': { '2008': 0, '2009': 0, '2013': 1, '2015': 0, '2017': 0 } })
    });

});

describe('testing extraRuns function ', () => {
...
describe('testing economy function', () => {
    ...
    test('Economy of bowler', () => {
        expect(IPL.topTenEconomicalBowler(sampleMatchesEconomy, sampleDeliveryEconomy)).toEqual({ "RN ten Doeschate": 22 }, { "J Yadav": 3 })
    })
});
